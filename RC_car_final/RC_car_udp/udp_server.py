...
UDP Server with XInput library for gamepad readout.
XInput code adapted from Jason R. Coombs' code (under MIT license terms):
...
from pyglet import event # python -m pip install pyglet
...
def sample_first_joystick(sock, addr):
    """
